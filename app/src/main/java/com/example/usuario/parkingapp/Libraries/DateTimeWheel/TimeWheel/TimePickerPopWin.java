package com.example.usuario.parkingapp.Libraries.DateTimeWheel.TimeWheel;
...
public class TimePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    private void initPickerViews() {
        ...
        hourLoopView.setInitPosition(hourPos - 1);
    ...
    public void onClick(View v) {
        ...
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                sb.append(String.valueOf(format2LenStr(hour)));
                sb.append(":");
